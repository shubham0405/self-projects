    ...
    def on_reward(self, reward):
        ...
        while self.state_order:
            ...
            if state_key in self.states:
                ...
                print('update learning', state_key, action, reward)
...
#                best_values[str(idx)] = value
	...
	print(best_values)
        ...
        print('best_value_indices', best_value_indices)
